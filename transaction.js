...
async function main() {
  // const uri =
  //   "mongodb+srv://admin:admin123@protrasys-admin-raot8.mongodb.net/<dbname>?retryWrites=false&w=majority";

  const uri =
    "mongodb://127.0.0.1:27017/sample_airbnb?retryWrites=false&w=majority";
